...
?>
  ...
  <td align="center"><?php echo $this->_var['t']['a']; ?></td>
    ...
    <a href="javascript:;"  url="<?php echo $this->_var['appadmin']; ?>?m=navbar&a=delete&id=<?php echo $this->_var['t']['id']; ?>" class="del" >删除</a></td>
  </tr>
...
?>
  ...
  <td align="center"><?php echo $this->_var['c']['a']; ?></td>
    ...
    <a href="javascript:;"  url="<?php echo $this->_var['appadmin']; ?>?m=navbar&a=delete&id=<?php echo $this->_var['c']['id']; ?>" class="del" >删除</a>
    </td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <?php endif; ?>
